...
import HeroImagePhone from '../assets/img/Hero Image (Tablet and Mobile).jpg'
import Airbnb from '../assets/icons/Airbnb.svg'
import Booking from '../assets/icons/Booking.svg'
import Plum from '../assets/icons/Plum Guide.svg'
import { CheckCircle } from '@mui/icons-material'
import { motion } from 'framer-motion'
import Link from 'next/link'

const NextGrid = styled(Grid)(({ theme }) => ({
  display: 'none',
  margin: 0, padding: 0,
  position: 'relative',
  height: '100vh',
...
export default function Home() {
  return (
    <motion.div exit={{ opacity: 0, transition: { duration: 0.2, ease: 'easeOut' } }} initial='initial' animate='animate' >
      <Head>
      ...
      <motion.main initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.1 }}>
        ...
        <Grid container sx={{
          ...
          <Grid item md={7} >
            ...
            >
              <motion.div variants={stagger} >
                ...
                <ul >
                  <motion.li variants={slideFromLeft} className='item'>
                    <CheckCircle htmlColor='#09AF07' /> Add your own camp suggestions.
                  </motion.li>
                  <motion.li variants={slideFromLeft} className='item'>
                    <CheckCircle htmlColor='#09AF07' /> Leave reviews and experiences.
                  </motion.li>
                  <motion.li variants={slideFromLeft} className='item'>
                    <CheckCircle htmlColor='#09AF07' /> See locations for all camps.
                  </motion.li>
                </ul>
                ...
                >
                  ...
                  <Stack direction='row'>
                    <Image src={Airbnb} alt='something' />
                    <Image src={Booking} alt='something' />
                    <Image src={Plum} alt='something' />
                  </Stack>
                </Box>
              </motion.div>
            </Box>
          ...
          <NextGrid md={5} item >
            <motion.div variants={fadeIn} initial='initial' animate='animate'>
              <Image src='/img/Hero Image.jpg' alt='' layout='fill' objectFit='cover' />
            </motion.div>
          </NextGrid>
        </Grid>
