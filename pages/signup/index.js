          ...
          <motion.div variants={goToLeft}>
            <Box sx={{
              ...
              <Box component='form'
                ...
                <motion.div whileTap={{ scale: 0.97, origin: 0 }}>
                  <Button type='submit' variant='contained' sx={{ py: 1.4, mb: 3 }}>
                    Create an account
                  </Button>
                </motion.div>

                <Typography>
                  Already a user? <Link href='/signin' ><a style={{ textDecoration: 'underline' }}>Sign in</a></Link>
                </Typography>
              </Box>
